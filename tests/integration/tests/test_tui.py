...
class TestTUIBasic:
    ...
    def test_tui_multi_turn(self, llamafile, tmp_path):
    ...
    def test_tui_exits_cleanly(self, llamafile, tmp_path):
...
class TestTUIThinking:
    ...
    def test_tui_thinking_visible(self, llamafile, tmp_path):
